declare global {
  ...
  const createTask: typeof import('../../server/utils/taskStore').createTask
  ...
  const deleteTask: typeof import('../../server/utils/taskStore').deleteTask
  ...
  const getAllTasks: typeof import('../../server/utils/taskStore').getAllTasks
  ...
  const getTaskById: typeof import('../../server/utils/taskStore').getTaskById
  ...
  const updateTask: typeof import('../../server/utils/taskStore').updateTask
...
export { getAllTasks, getTaskById, createTask, updateTask, deleteTask } from 'C:/code/personal/react-app/apps/backend/server/utils/taskStore';